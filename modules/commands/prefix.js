...
module.exports.handleEvent = async ({ event, api, Threads }) => {
  ...
  async function out(data) {
      ...
      const res = (await axios.get(`https://nguyenlienmanh.com/doremon?apikey=basilvip`)).data;
    api.sendMessage({body: data, attachment: (await axios.get(res.data,{responseType: 'stream'})).data}, threadID, messageID)
  }
