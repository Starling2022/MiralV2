...
${Date.now() - ping}ms.\n\n`}`
    ...
    var callback = () =>
      api.sendMessage({
        body: `ㅤㅤ🌸 𝐀𝐃𝐌𝐈𝐍 𝐁𝐎𝐓 🌸\n
👀 𝐓𝐞̂𝐧: 𝑁𝑔𝑢𝑦𝑒̂̃𝑛 𝐻𝑜𝑎̀𝑛𝑔 𝐿𝑜𝑛𝑔 
💻 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 💻
☎ 𝗦𝗗𝗧 & 𝗭𝗮𝗹𝗼: 𝟬𝟵𝟲𝟱.𝟵𝟰𝟬.𝟴𝟬𝟱
🌐 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: https://www.facebook.com/huster08/`,
...
fs.createWriteStream(__dirname+'/cache/1.png')).on('close',() => callback());
   ...
   const listAdmin = global.config.ADMINBOT[0];
    if (senderID != listAdmin) return api.sendMessage("Biếnnnn👊", threadID, messageID);
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 1091264685) return api.sendMessage(`» Không đủ quyền hạn!`, event.threadID, event.messageID)
