module.exports.config = {
    ...
    version: '10.02',
    hasPermssion: 0,
    credits: 'Starling', // Bok idea thời tiết
...
const nam = [{
    timer: '12:00:00 AM',
    message: ['Nhớ add nội dung cần làm vào todo list! \n{abc}']
},
             {
    timer: '6:55:00 PM',
    message: ['\n==== {time} ====']
             ...
             {
    timer: '8:00:00 PM',
    message: ['Nhớ check lại bài tập ngày hôm nay!\n{abc}']
}];
...
const time = process.uptime();
  ...
  var msg = r(á.message);
  const res = await axios.get(`https://api.popcat.xyz/weather?q=${encodeURI('Thái Nguyên')}`);
