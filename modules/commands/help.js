  ...
  const { commands } = global.client;
    ...
    if (type) {
        ...
        for (const cmd of array) {
          msg1 = `======『 𝗛𝗘𝗟𝗣 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 』======\n\n`
            msg += `[💝] ➜ 𝗡𝗵𝗼́𝗺: ${cmd.cmdCategory.toUpperCase()}\n[🧸] ➜ 𝗧𝗼̂̉𝗻𝗴: ${cmd.nameModule.length} 𝗹𝗲̣̂𝗻𝗵\n[⚜️]➜ 𝗾𝘂𝘆𝗲̂̀𝗻 𝗵𝗮̣𝗻: ${TextPr(cmd.permission)}\n[🔎] ➜ 𝗖𝗮́𝗰 𝗹𝗲̣̂𝗻𝗵: ${cmd.nameModule.join(", ")}\n\n`
        }
...
url: (await global.nodemodule["axios"]('https://i.imgur.com/tUMV0ui.gif')).data.data,
method: "GET",
responseType: "stream"
})).data
